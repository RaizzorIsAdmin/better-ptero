# :bird: Better-Ptero | Установщик панели Pterodactyl
...
|                  | 16.04   | :red_circle: \*    |             |
|                  | 18.04   | :red_circle:       | 8.3         |
|                  | 20.04   | :red_circle:       | 8.3         |
...
```
<br>**Статус:** :red_circle: Недоступно</br>
<br>**ВНИМАНИЕ:** Для полноценной работы скрипта, нужно быть авторизованным как `root`, иначе ничего не получится.</br>
