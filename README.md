...
Неофициальные скрипты для Pterodactyl Panel & Wings. Работает с последней версией
...
```bash
bash <(curl -s https://better-ptero.se)   [ UNDER CONSTRUCTION ]
```
